...
# Setup JS Mocks
js = sys.modules["js"]
js.Response.new = MagicMock(side_effect=lambda body, init=None: {"body": body, "init": init})
...
async def test_registry():
    ...
    binding.idFromName.return_value.getStub.return_value = stub
    ...
    binding.idFromName.assert_called_with("test-123")
...
async def test_serialization():
    ...
    # Mock put/get
    store = {}
    async def put(k, v): store[k] = v
    async def get(k): return store.get(k)
