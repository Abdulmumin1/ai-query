...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "ToolCallDeltaEvent": ("ai_query.types", "ToolCallDeltaEvent"),
    "ToolCallStartedEvent": ("ai_query.types", "ToolCallStartedEvent"),
    "ToolExecutionFinishedEvent": ("ai_query.types", "ToolExecutionFinishedEvent"),
    "ToolExecutionProgressEvent": ("ai_query.types", "ToolExecutionProgressEvent"),
    "ToolExecutionStartedEvent": ("ai_query.types", "ToolExecutionStartedEvent"),
    "ToolExecutionContext": ("ai_query.types", "ToolExecutionContext"),
    "ToolResultEvent": ("ai_query.types", "ToolResultEvent"),
    "RetryEvent": ("ai_query.types", "RetryEvent"),
    "RetryPolicy": ("ai_query.types", "RetryPolicy"),
    "StopDecision": ("ai_query.types", "StopDecision"),
    "TurnTermination": ("ai_query.types", "TurnTermination"),
    ...
    "ToolOutput": ("ai_query.types", "ToolOutput"),
    "UnsupportedToolOutputError": ("ai_query.types", "UnsupportedToolOutputError"),
    "ToolResult": ("ai_query.types", "ToolResult"),
    "TextPart": ("ai_query.types", "TextPart"),
    "ImagePart": ("ai_query.types", "ImagePart"),
    "FilePart": ("ai_query.types", "FilePart"),
