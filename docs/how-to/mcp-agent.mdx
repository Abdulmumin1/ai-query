...
Combine the [`Agent`](/reference/agent) class with [MCP](/explanation/mcp) to create intelligent agents that use external tools from MCP servers.
...
<CardGroup cols={2}>
  <Card title="MCP Integration" icon="plug" href="/explanation/mcp">
