...
If you want Gemini thought text to arrive as reasoning events during streaming, `include_thoughts` must be enabled. See [`Thinking`](/explanation/thinking) for the streaming callback model.
