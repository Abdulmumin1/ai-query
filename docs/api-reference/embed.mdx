...
|-------|------------|------------|-------------|
| `text-embedding-3-large` | 3072 | 8192 | Highest quality |
| `text-embedding-3-small` | 1536 | 8192 | Fast and affordable |
...
| Model | Dimensions | Max Tokens | Description |
|-------|------------|------------|-------------|
| `gemini-embedding-001` | 128-3072 | 2048 | Latest model with flexible dimensions |
