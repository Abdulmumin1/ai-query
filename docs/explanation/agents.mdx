...
Control when the agent loop terminates using [stop conditions](/reference/types/stop-conditions).
...
```python
from ai_query import generate_text
from ai_query.providers import google, StepStartEvent
