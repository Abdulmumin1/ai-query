...
ending the caller-side wait. Once the signal aborts, a target success returned
during that cleanup grace period is discarded rather than overriding the abort.
