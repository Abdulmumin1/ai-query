...
<CardGroup cols={2}>
  <Card title="Providers" icon="server" href="/how-to/providers/openai">
    Configure and customize AI providers
  </Card>
  <Card title="Tool Calling" icon="wrench" href="/explanation/tools">
    Build powerful tools with type safety
  </Card>
  <Card title="Streaming" icon="bolt" href="/explanation/streaming">
    Learn advanced streaming patterns
  </Card>
  <Card title="Stateful Agents" icon="robot" href="/explanation/stateful-agents">
    Build persistent AI agents
  </Card>
  <Card title="Abort/Cancellation" icon="circle-stop" href="/explanation/abort">
    Control long-running operations
  </Card>
  <Card title="Embeddings" icon="cube" href="/explanation/embeddings">
