...
# (AgentServer with factory function)
...
It is best practice for agents to communicate progress via events.

For full details on event persistence and replay, see the [Events Guide](/core/events).
...
<CardGroup cols={2}>
  <Card
    ...
    icon="cloud"
    href="/cookbook/serverless-agents"
  >
